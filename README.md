...
```bash
# create new app
npx nx g @nx/react:app apps/reports --bundler=rspack --style=scss --js=false
# create new remote
npx nx g @nx/react:remote apps/reports --bundler=rspack --style=scss --js=false
#remove apps
npx nx g @nx/workspace:remove reports
```
